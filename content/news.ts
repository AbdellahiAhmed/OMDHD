...
const draftedNews: NewsArticle[] = [
  {
    ...
    body: {
      ar: [
        'نظمت المنظمة الموريتانية للدفاع عن حقوق الإنسان والتنمية البشرية دورة تدريبية مكثفة على مدى يومين كاملين في العاصمة نواكشوط، استهدفت مجموعة من الشباب والناشطين في المجتمع المدني.',
